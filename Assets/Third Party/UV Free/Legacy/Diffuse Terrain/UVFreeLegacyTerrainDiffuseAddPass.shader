...
Shader "Hidden/UVFree/Terrain/LegacyDiffuse-AddPass" {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf Lambert decal:add vertex:SplatmapVert finalcolor:SplatmapFinalColor finalprepass:SplatmapFinalPrepass finalgbuffer:SplatmapFinalGBuffer fullforwardshadows
