...
Shader "UVFree/StandardMetallic/Single-Texture Unity 5.6 Error Fix (Disable Parallax)" {
	Properties {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			#ifdef _PARALLAXMAP
			// Gao Ming: Temp fix an error caused by dynamic batching and parallax mapping after upgraded to Unity 5.6
