...
Shader "UVFree/Terrain/StandardSpecular" {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf StandardSpecular vertex:SplatmapVert  finalcolor:SplatmapFinalColor finalprepass:SplatmapFinalPrepass finalgbuffer:SplatmapFinalGBuffer fullforwardshadows
