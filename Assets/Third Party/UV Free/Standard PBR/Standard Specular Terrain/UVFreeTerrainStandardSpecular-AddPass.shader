...
Shader "Hidden/UVFree/Terrain/StandardSpecular-AddPass" {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf StandardSpecular decal:add vertex:SplatmapVert  finalcolor:SplatmapFinalColor finalprepass:SplatmapFinalPrepass finalgbuffer:SplatmapFinalGBuffer fullforwardshadows
