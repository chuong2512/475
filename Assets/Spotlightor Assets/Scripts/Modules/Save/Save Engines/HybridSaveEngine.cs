...
public class HybridSaveEngine : SaveEngine
{
		...
		get {
			if (instance == null) {
				...
				if (instance == null) {
					...
					instance.engineSettings = new List<SaveEngineSetting> ();
					SaveEngineSetting playerPefsEngineSetting = new SaveEngineSetting ();
					playerPefsEngineSetting.engine = ScriptableObject.CreateInstance<PlayerPrefsSaveEngine> ();
					playerPefsEngineSetting.platforms = new List<RuntimePlatform> ();
					instance.engineSettings.Add (playerPefsEngineSetting);
	...
	[SerializeField]
	protected List<SaveEngineSetting> engineSettings;
