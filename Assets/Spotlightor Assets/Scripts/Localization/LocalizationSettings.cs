...
public class LocalizationSettings : ScriptableObject
{
	...
	public List<LocalizationLanguageTypes> availableLanguageTypes;
		...
		get {
			if (instance == null) {
				...
				if (instance == null) {
					...
					instance.availableLanguageTypes = new List<LocalizationLanguageTypes> (){ LocalizationLanguageTypes.English };
